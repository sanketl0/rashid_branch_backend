...
class OwnerDrawing(BaseDateid):
    ownerdrawing_id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    ...
    owners_drawing_ref_no = models.CharField(max_length=200, blank=True, default='null', null=True)
    ...
    def __str__(self):
        return str(self.ownerdrawing_id)