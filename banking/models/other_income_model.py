...
# Model Other Income
class OtherIncome(BaseDateid):
    oi_id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    ...
    other_income_ref_no = models.CharField(max_length=200, blank=True, default='null', null=True)
