...
# OwnersContribution model
class OwnersContribution(BaseDateid):
    oc_id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    ...
    transaction_module = models.CharField(max_length=200, blank=True, default='null', null=True)
    status = models.CharField(max_length=200, blank=True, default='null', null=True)
    transaction_type = models.CharField(max_length=200, blank=True, default='null', null=True)
    ...
    owners_cont_ref_no = models.CharField(max_length=200, blank=True, default='null', null=True)
