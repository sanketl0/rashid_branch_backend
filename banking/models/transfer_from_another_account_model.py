...
class TransferFromAnotherAccount(BaseDateid):
    tfaa_id = models.UUIDField(primary_key=True, default=uuid.uuid4)
    ...
    transfer_from_ref_no = models.CharField(max_length=200, blank=True, default='null', null=True)
